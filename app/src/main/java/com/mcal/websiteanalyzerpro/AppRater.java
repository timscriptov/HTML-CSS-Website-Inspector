...
public class AppRater {
    ...
    public static void app_launched(Context mContext) {
        ...
        if (!prefs.getBoolean("dontshowagain", false)) {
            ...
            if (launch_count >= 5 && System.currentTimeMillis() >= date_firstLaunch + 86400000) {
    ...
    private static void showRateDialog(final Context mContext, final Editor editor) {
        ...
        b1.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                mContext.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=com.mcal.websiteanalyzerpro")));
                dialog.dismiss();
            }
        });
        ll.addView(b1);
